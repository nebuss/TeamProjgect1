...
af_covid
------------------------------------------------------------------
#2020, 2021(covid 중) 1인당 평균 매출액 구하기
#1. 2020, 2021 각 변수(국내, 관광, 기타)별로 합계 구하기
var_a = du_covid.transpose()
var_a['total']= var_a['sum_20']+var_a['sum_21']
var_a

#2. 2020, 2021 1로 산출된 합계를 조사자 수로 나누기
#2020년: 50400명, 2021년: 51600명)
#도합 102000 명
var_a['mean'] = var_a['total'] / 102000
var_a
